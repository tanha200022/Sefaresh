...
try:
    import flet as ft
    # این خط باعث می‌شود فلت مجبور شود هسته خود را لود کند 
    # و اگر فایلی کسر دارد، خطای واقعی را نشان دهد
    import flet.app 
    import jdatetime
    ...
    def main(page: ft.Page):
        ...
        comp_dialog = ft.AlertDialog(
            title=ft.Text("افزودن شرکت", size=22, weight=ft.FontWeight.BOLD),
...
# اگر خطایی در لایه‌های پنهان وجود داشته باشد، این بخش آن را شکار کرده و نشان می‌دهد
